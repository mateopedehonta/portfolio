...
export const MyService = () => {
  return (
    <div className="w-full md:h-[40vh] bg-gray-100 flex flex-col justify-around py-10">
      ...
      <div className="flex flex-col  md:flex-row items-center justify-center gap-10">
        <div className="h-[155px] w-[280px] border border-gray-200 rounded-lg p-4 flex flex-col justify-around items-center md:items-start">
          <Image
            width={10}
            height={10}
            alt=""
